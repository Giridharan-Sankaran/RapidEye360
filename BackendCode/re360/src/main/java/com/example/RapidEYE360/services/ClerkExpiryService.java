...
@Service
public class ClerkExpiryService {

    @Autowired
    private MongoTemplate mongoTemplate;

    @Autowired
    private ClerkExpiryRepository repository;

    public String generateRandomUsername() {
        String collectionName = "clerklogin";
    ...
    public List<ClerkExpiry> findAllExpiredProductsClerk(){
